...
const SignUp = () => {
  ...
  return (
    ...
    <div className="flex h-screen">
      ...
      {/* Right Pane */}
      <div className="flex justify-center flex-1 items-center bg-white">
        <form
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center mt-10 md:mt-4 space-y-6 md:space-y-8">
            ...
            <div className="flex bg-gray-100 rounded-lg focus:border border-violet-600 focus:outline-none text-black placeholder:text-gray-600 placeholder:opacity-50 font-semibold md:w-72 lg:w-[340px]">
              ...
              />
              <div
                className="cursor-pointer text-xl px-5 py-2"
          ...
          <button className="uppercase px-24 md:px-[118px] lg:px-[140px] py-2 rounded-md text-white bg-violet-500 hover:bg-violet-600 font-medium mt-6">
            Sign Up
          </button>
